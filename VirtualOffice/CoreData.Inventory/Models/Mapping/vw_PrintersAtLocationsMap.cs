...
{
    public class vw_PrintersAtLocationsMap : EntityTypeConfiguration<vw_PrintersAtLocations>
    {
        public vw_PrintersAtLocationsMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_PrintersAtLocations");
