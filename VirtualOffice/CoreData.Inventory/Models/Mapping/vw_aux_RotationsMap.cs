...
{
    public class vw_aux_RotationsMap : EntityTypeConfiguration<vw_aux_Rotations>
    {
        public vw_aux_RotationsMap()
        {
            // Primary Key
            ...
            this.Property(t => t.Reasson).HasColumnName("Reasson");
