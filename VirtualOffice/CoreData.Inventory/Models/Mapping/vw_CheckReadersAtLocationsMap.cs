...
{
    public class vw_CheckReadersAtLocationsMap : EntityTypeConfiguration<vw_CheckReadersAtLocations>
    {
        public vw_CheckReadersAtLocationsMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_CheckReadersAtLocations");
