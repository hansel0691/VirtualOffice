...
{
    public class vw_PrintersAtMerchantsMap : EntityTypeConfiguration<vw_PrintersAtMerchants>
    {
        public vw_PrintersAtMerchantsMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_PrintersAtMerchants");
