...
{
    public class vw_CheckReadersAtMerchantsMap : EntityTypeConfiguration<vw_CheckReadersAtMerchants>
    {
        public vw_CheckReadersAtMerchantsMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_CheckReadersAtMerchants");
