...
{
    public class POS_Inv_Orders1Map : EntityTypeConfiguration<POS_Inv_Orders1>
    {
        public POS_Inv_Orders1Map()
        {
            // Primary Key
            ...
            this.Property(t => t.Queue_Date).HasColumnName("Queue_Date");

            // Relationships
            this.HasOptional(t => t.POS_Inv_DeployMethods)
                .WithMany(t => t.POS_Inv_Orders1)
                .HasForeignKey(d => d.deploymethID);
